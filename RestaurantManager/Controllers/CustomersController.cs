...
namespace RestaurantManager.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(RestaurantManagerContext context, ILogger<CustomersController> logger, ICustomerService customerService)
        {
            _context = context;
            _logger = logger;
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,PhoneNumber")] Customer customer)
        {
            ...
            _logger.LogWarning("Model state is invalid while creating a customer.");
            return View(customer);
        }
