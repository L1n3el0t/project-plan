...
## Test plan
Ensure endpoint returns Healthy after running migrations, remove the seed calls from Program.cs, type drop-database in Package Manager Console, then add health endpoint again to ensure it returns Unhealthy
# Week 14 – Logging
## Feature
